...
public class FifthFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater
                .inflate(R.layout.fifth_fragment, container, false);
        ...
        final MediaPlayer sound= MediaPlayer.create(view.getContext(),R.raw.macaw);
        sound.start();
        ...
        btn1.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
				 ...
				 */
                trans.replace(R.id.root_frame, new FourthFragment());
                sound.stop();
				/*
