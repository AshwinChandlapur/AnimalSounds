...
public class YbirdFragment2 extends Fragment {
    TextView t;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.ybird2_fragment, container, false);


        ImageButton btn=(ImageButton)view.findViewById(R.id.btn);
        ImageButton btn1=(ImageButton)view.findViewById(R.id.btn1);
        // Button btn = (Button) view.findViewById(R.id.btn);
        final MediaPlayer sound= MediaPlayer.create(view.getContext(),R.raw.seagull);
        sound.start();
        ...
        btn.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
				 ...
				 */
                trans.replace(R.id.root_framey, new YbirdFragment3());
                sound.stop();
				/*
