...
public class XarmFragment4 extends Fragment {
    TextView t;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.xarm4_fragment, container, false);


        ImageButton btn=(ImageButton)view.findViewById(R.id.btn);
        ImageButton btn1=(ImageButton)view.findViewById(R.id.btn1);
        // Button btn = (Button) view.findViewById(R.id.btn);
        final MediaPlayer sound= MediaPlayer.create(view.getContext(),R.raw.pig);
        sound.start();
